    ...
    return (
        <div>
            ...
            <div>
                ...
                <EmployeeCard img={'ai_automation_expert.png'} title={'AI Automation Expert  - Dima'} description={'Builds AI-powered automation systems and integrations using modern APIs and language models to streamline workflows and improve business decision-making'} />
